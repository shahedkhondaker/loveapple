...
<div class="container">
	...
	<div class="span-12 last">	
		<form:form action="/member/complet" modelAttribute="memberForm" method="post">
		  	<fieldset>		
				...
				<p>
					...
					<form:hidden path="familyName" /> <form:errors path="familyName" />			
				</p>
				<p>	
				...
				<p>
					...
					<form:hidden path="nickName" /> <form:errors path="nickName" />
				</p>
				<p>	
				...
				<p>
					...
					<form:hidden path="sexStr" /> <form:errors path="sexStr" />
				</p>
				<p>	
					<input type="submit" />
				</p>
