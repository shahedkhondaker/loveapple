...
import cn.loveapple.service.controller.ResourceNotFoundException;
...
public class SampleController {
	 ...
	 * ログ
	 */
	private static Logger log = Logger.getLogger(SampleController.class.getName());
	...
	public String getView(@PathVariable Long id, Model model) {
		...
		if(data == null){
			if(log.isLoggable(Level.FINEST)){
				log.finest("location list is empty by id :[" + id + "]");
			}
